      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid md:grid-cols-[280px_1fr] gap-8 items-stretch">
            ...
            <div className="flex flex-col justify-center space-y-4 text-muted-foreground leading-relaxed text-left lg:text-justify">
              <p>
