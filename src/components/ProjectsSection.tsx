...
const projects = [
  ...
  },
  {
    ...
    bullets: [
      "Analyzed internal workflows across 5+ business functions to identify process bottlenecks, improving visibility into task ownership and execution timelines.",
      ...
      "Implemented alert-based escalation and automated checklists for delayed tasks, dispatch, and procurement, improving accountability, turnaround time, and operational efficiency.",
      "Generated and analyzed MIS reports to track KPIs for 15+ employees on a weekly and monthly basis, enabling data-driven decision-making for management.",
      "Explored AI tools to support rapid prototyping, improving efficiency in process optimization tasks by ~25%.",
    ],
